...
import com.quardroiders.AllWordsListActivity.OnItemLongClickListener;
...
public class PersonalWordsListActivity extends Activity {
		...
		wordsList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (!receiver.equals(LoginActivity.mName)){
					...
					intent.setClass(PersonalWordsListActivity.this,
							InputMSGActivity.class);
					intent.putExtras(bundle);
					PersonalWordsListActivity.this.startActivity(intent);
				}
			}
		});
	...
	public boolean onContextItemSelected(MenuItem menuItem) {
		...
		if (menuItem.getTitle().equals("Show Location")) {
			...
			intent.putExtras(bundle);
			PersonalWordsListActivity.this.startActivity(intent);
		} else if (menuItem.getTitle().equals("Be a Friend")) {
